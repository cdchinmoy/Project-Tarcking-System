            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <?php echo form_open('report/filter_report',array('class' => '','id'=>'task_list')); ?>
                            ...
                            <div class="" style="float:left;">
                                <div class="col-md-3 col-4 align-self-center">
                                    <!--<input type="text" class="form-control" name="project_id" placeholder="Project Name" style="width: 240px;">-->
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="col-md-12 col-6 align-self-center" style="padding-bottom:35px;">
									<a href="<?php echo base_url().'report/gen_report'; ?>" class="btn col-md-3 col-2 pull-right hidden-sm-down btn-success">Generate Report</a>
                                </div>
                                        ...
                                        <tbody>
                                         <?php 
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $list->manager_score; ?></td>
                                                </tr>
