    ...
    <div class="col-sm-12">
     <div class="card">
        ...
        <?php echo form_open('task/time_management_filter',array('class' => '','id'=>'task_time_management')); ?>
           ...
           <div class="" style="float:left;">
                <div class="col-md-3 col-3 align-self-center">
                    <input type="text" class="form-control" name="datefilter" placeholder="Date" style="width: 190px;" value="<?php echo $this->input->post('datefilter'); ?>">
            	</div>
            </div>
...
?>
	<!--<div style="background:#CCC !important; padding: 5px;">-->
	<h4 class="card-title fa fa-book"><?php echo $project->project_name; ?></h4>
		<div class="row">
				<div class="col-sm-12">
					<div class="card">
						<div class="card-block">
						<h4 class="card-title" style="float:left"><?php echo $project->task_name; ?> (Manhour : <?php echo $t_time = get_total_time_by_id($project->task_main_id, $project->project_id); $time = $time + $t_time; ?> HOUR)</h4>
							<?php /* ?><button type="button" class="btn btn-info pull-right" data-toggle="collapse" data-target="#<?php echo $project->task_main_id; ?>" onclick="toggler(this)" id="<?php echo $project->task_name; ?>">+</button><?php */ ?>
							  <div id="<?php echo $project->task_main_id; ?>" class="">
								<div class="table-responsive m-t-40">
									<table class="table stylish-table">
										...
										$task_list = get_task_list_by_id($project->project_id,$project->task_main_id); 
										...
										if($count > 0)
										{
										 ...
										 ?>
											<tr>
												...
												<td><?php $date = view_date_format($task->task_date); echo $date; ?></td>
