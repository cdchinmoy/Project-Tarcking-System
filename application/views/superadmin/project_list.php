        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
					...
					<div class="col-md-2 col-2 align-self-center">
                        <a href="<?php echo base_url()."project/remove_employee"; ?>" class="btn pull-right hidden-sm-down btn-success"> Remove Employee</a>
                    </div>
					<br />
                                ...
                                <div class="col-md-3 col-4 align-self-center">
                                     <select class="form-control" name="project_id" style="width: 240px;">
                                    	<option value="">Project Name</option>
                                           ...
                                           if($count > 0)
                                           {
                                               foreach($all_project_data as $list)
                                               { 
                                               ?>
                                ...
                                <div class="table-responsive" id="task_table">
                                    ...
                                    <table class="table table-hover table-bordered results">
										...
										if($count > 0)
										{
											...
											{
											?>
												<tr <?php if($project_data->notification_status ==0 || $project_data->notification_status ==2){ echo "style='background:#E1E1D2 !important;'"; } ?>>
													<td><?php echo $i; ?></td>
													...
													<td><?php $date = view_date_format($project_data->project_deadline);
														echo $date; ?></td>
													<td><?php echo "<a class='view' href='".base_url()."project/project_details/".$project_data->project_id."'>View</a>"; ?>
													<?php echo " | <a class='delete' href='".base_url()."project/delete_project/".$project_data->project_id."' onclick='return confirm('Are you sure to delete the project?')' ; >Delete</a>"; ?>
													<?php echo " | <a class='view' href='".base_url()."project/update_project/".$project_data->project_id."'>Update</a>"; ?>
													</td>
												</tr>
											<?php 
											$i = $i + 1;
