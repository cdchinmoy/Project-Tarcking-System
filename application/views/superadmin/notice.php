...
<div class="row">
	<div class="col-sm-12">
		<div class="card">
			...
			<h4 class="card-title" style="float:left">General Notices</h4>&nbsp;&nbsp;&nbsp;<button name="add_general" type="button" id="add_general" class="btn hidden-sm-down btn-success" style="font-size:11px;" data-toggle="modal" data-target="#generalModal">Add New</button>
