        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <div class="card-block">
								...
								<?php echo form_open('project/update_assign_project',array('class' => '','id'=>'update_assign_employee')); ?>
                                    ...
                                    <div class="form-group" style="margin-top:15px;">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success" onclick="add_employee_func();">Remove</button>
			...
			$(document).ready(function(e) {
				...
				$.ajax({
					...
					url: "<?php echo base_url()."project/ajax_remove_employee"; ?>",
...
{
	document.getElementById("update_assign_employee").submit();
}
