...
<button type="button" name="show_current" id="show_current" onclick="toggler(this)" class="btn btn-success"><i class=" fa fa-eye"></i> Show</button>
                                    </div>
                                </div><br />
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3" style="float:left;">
                                    	<button type="button" name="show_new" id="show_new" onclick="toggler(this)" class="btn btn-success"><i class="fa fa-eye"></i> Show</button>
                                    </div>
                                </div><br />
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3" style="float:left;">
                                 <button type="button" name="show_confirm" id="show_confirm" onclick="toggler(this)" class="btn btn-success"><i class="fa fa-eye"></i> Show</button>
                                    </div>
                                </div>
                                <br />
                                <div class="form-group">
    ...
    <script>
		function toggler(e) {
			if( e.innerHTML == '<i class=" fa fa-eye"></i> Show' ) {
				if(e.id == 'show_current'){
					e.innerHTML = '<i class=" fa fa-eye-slash"></i> Hide'
				...
				if(e.id == 'show_confirm'){
				 ...
				 if(e.id == 'show_current'){
					e.innerHTML = '<i class=" fa fa-eye"></i> Show'
