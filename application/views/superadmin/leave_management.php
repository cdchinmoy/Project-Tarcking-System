							 ...
							 ?>
								<tr>
									...
									<td>
										...
										<?php /* ?><a href="<?php echo base_url()."leaves/delete_leave/".$casual->leave_id; ?>"><button name="delete_casual" id="delete_casual" class="btn hidden-sm-down btn-danger">Delete</button></a>
						...
						<table class="table stylish-table">
							...
							?></small></td>
									...
									<td>
										...
										<?php /* ?><a href="<?php echo base_url()."leaves/delete_leave/".$paid->leave_id; ?>"><button name="delete_paid" id="delete_paid" class="btn hidden-sm-down btn-danger">Delete</button></a>
							 ...
							 ?>
								<tr>
									...
									<td>
										...
										<?php /* ?><a href="<?php echo base_url()."leave/delete_leave/".$sick->leave_id; ?>"><button name="delete_sick" id="delete_sick" class="btn hidden-sm-down btn-danger">Delete</button></a>
