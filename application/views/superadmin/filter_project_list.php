											...
											?>
												<tr>
													...
													<td><?php $date = view_date_format($project_data->project_deadline);
														echo $date; ?></td>
													<td><?php echo "<a class='view' href='".base_url()."project/project_details/".$project_data->project_id."'>View</a>"; ?><?php echo " | <a class='delete' href='".base_url()."project/delete_project/".$project_data->project_id."' onclick='return confirm('Are you sure to delete the project?')' ; >Delete</a>"; ?></td>
												</tr>
											<?php 
											$i = $i + 1;
											}
