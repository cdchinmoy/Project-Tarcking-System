                                    ...
                                    <table class="table table-hover table-bordered results">
										...
										?>
                                            <tr>
												...
												<td>												
												<a href="<?php echo base_url().'employee/view_employee/'.$user_data->user_id; ?>">View</a>
												<?php if($user_data->user_type != 1){ ?>
																							
												<a href="<?php echo base_url().'employee/delete_employee/'.$user_data->user_id; ?>" onclick="return confirm('Are you sure to delete all tasks?');">Delete</a>	<?php } ?>

												<a href="<?php echo base_url().'employee/update_employee/'.$user_data->user_id; ?>">Update</a>
