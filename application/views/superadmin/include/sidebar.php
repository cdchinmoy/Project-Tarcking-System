...
<div class="scroll-sidebar">
	...
	<nav class="sidebar-nav">
		<ul id="sidebarnav">
            ...
            <li>				
				<a href="<?php echo base_url()."task/project_milestone"; ?>" class="waves-effect"><img src="http://exoticapages.ca/pts/assets/upload/profile_image/icon3.png" style="margin-right:9px;" /></i>Project Milestone</a></li>						
