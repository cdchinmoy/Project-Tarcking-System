...
<!-- All Jquery -->
	...
	<?php /* ?><script type="text/javascript" src="<?php echo base_url(); ?>assets/salarychart/js/fusioncharts.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/salarychart/js/fusioncharts.theme.fint.js?cacheBust=56"
	<?php */ ?>	
	...
	<div class="navbar-collapse">
		...
		<ul class="navbar-nav my-lg-0">
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo base_url(); ?>assets/upload/profile_image/<?php echo $user_details[0]->user_iamge; ?>" alt="user" class="profile-pic m-r-5" /><?php echo $user_details[0]->name; ?></a>
			</li>
		</ul>
	</div>
	<script>
