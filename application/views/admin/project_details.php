                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
												...
												<td style="padding:20px 0 20px 50px;"><?php echo $project_details[0]->project_description; ?></td>
                                            </tr>
										    ...
										    <tr>
                                                <td style="width: 30%; font-weight:bold;padding:20px 0 20px 30px;">Project Deadline</td>
