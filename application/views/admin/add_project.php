                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
								<?php echo form_open('project/do_add_project',array('class' => '','id'=>'add_employee')); ?>
                                    ...
                                    <div class="form-group" style="margin-bottom: 5px;">
                                        <label class="col-md-12">Project Deadline</label>
                                        <div class="col-md-12">
                                            <input type="text" name="project_deadline" id="datepicker" placeholder="" class="form-control form-control-line" value="<?php echo $this->input->post('project_deadline'); ?>">
                                        </div>
                                    </div>
