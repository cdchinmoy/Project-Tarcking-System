                            ...
                            <div class="card-block">
                                ...
                                <input type="hidden" name="task_id" value="<?php echo $task_details[0]->task_id; ?>" />
                                    ...
                                    <div class="form-group" style="margin-bottom: 5px;">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="" class="form-control form-control-line" name="task_date" id="datepicker" value="<?php //echo $task_details[0]->task_date; 
											$today = getdate();
                                    ...
                                    <div class="form-group" style="margin-bottom: 5px;">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="start_time" class="start_time" id="start_time" placeholder="" class="form-control form-control-line" value="<?php echo $task_details[0]->task_start_time; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 5px;">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="end_time" class="end_time" id="end_time" placeholder="" class="form-control form-control-line" value="<?php echo $task_details[0]->task_end_time; ?>">
                                        </div>
                                    </div>
									...
									<div class="form-group" style="margin-bottom: 5px;">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="calculate_time" id="calculate_time" placeholder="" class="form-control form-control-line" value="<?php echo $task_details[0]->calc_task_time; ?>" onclick="Compare();">
                                        </div>
                                    </div>
