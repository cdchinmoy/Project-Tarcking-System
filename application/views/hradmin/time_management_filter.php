				...
				<div class="col-sm-12">
					<div class="card">
						...
						<h4 class="card-title" style="float:left"><?php echo $project->task_name; ?> (Manhour : <?php echo $t_time = get_total_time_by_id($project->task_main_id, $project->project_id); $time = $time + $t_time; ?> HOUR)</h4>
							<button type="button" class="btn btn-info pull-right" data-toggle="collapse" data-target="#<?php echo $project->task_main_id; ?>" onclick="toggler(this)" id="<?php echo $project->task_name; ?>">+</button>
							  <div id="<?php echo $project->task_main_id; ?>" class="collapse">
