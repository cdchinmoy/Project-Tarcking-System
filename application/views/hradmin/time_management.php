    ...
    <div class="col-sm-12">
     <div class="card">
        ...
        <?php echo form_open('task/time_management_filter',array('class' => '','id'=>'task_time_management')); ?>
           ...
           <div class="" style="float:left;">
                <div class="col-md-3 col-3 align-self-center">
                    <input type="text" class="form-control" name="datefilter" placeholder="Date" style="width: 220px;">
            	</div>
            </div>
		...
		<div class="col-sm-12">
			<div class="card">
                ...
                <h4 class="card-title" style="float:left"><?php echo $main_task->task_name; ?> (Manhour : <?php echo $t_time = get_total_time_by_id($main_task->task_main_id, $main_task->project_id); $time = $time + $t_time; ?> HOUR)</h4>
                    <button type="button" class="btn btn-info pull-right" data-toggle="collapse" data-target="#<?php echo $main_task->task_main_id; ?>" onclick="toggler(this)" id="<?php echo $main_task->task_name; ?>">+</button>
