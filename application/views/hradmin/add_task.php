                            ...
                            <div class="card-block">
                                ...
                                <input type="hidden" name="user_id" value="<?php echo $user_details[0]->user_id; ?>" />
                                    ...
                                    <div class="form-group" style="margin-bottom: 5px;">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="" class="form-control form-control-line" name="task_date" id="task_date" value="<?php $today = getdate(); echo $today['mon'].'/'.$today['mday'].'/'.$today['year']; ?>" readonly>
                                        </div>
                                    </div>
