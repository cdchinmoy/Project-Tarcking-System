...
<div class="row">
	<div class="col-sm-4">
        ...
        <?php /* ?><div class="col-sm-4">
			<div class="card">
				<div class="card-block" style="text-align:center; ">
                <center><div style="color:#903; font-size:24px; font-weight:bolder; margin-bottom:30px; background-color:#0FC; width:80%; box-shadow: 10px 10px 5px #999; border-radius:5px;">
        ...
        <!--<div class="col-sm-4">
			<div class="card">
				<div class="card-block" style="text-align:center; ">
                <b>Employee Notification:</b>
                	<?php /*?><?php if($task > 0){ echo '<center><a href="task/task_list" style="text-decoration:none;"><div align="center" style="background-color:green; height:60px ; width:60px; alignment-adjust:middle; border-radius:30px; color:#FFF; font-size:24px; font-weight:bolder; margin-top:30px; margin-bottom:30px; line-height:60px;">'.$task.'</div></a></center>' ; } else { echo '<center><div align="center" style="background-color:red; height:60px ; width:60px; alignment-adjust:middle; border-radius:30px; color:#FFF; font-size:24px; font-weight:bolder; margin-top:30px; margin-bottom:30px; line-height:60px;">0</div></center>'; } ?><?php */?>
                <?php /* ?><div>
                 New Notification
                </div>
                </div>
			...
			<div class="card">
				<div class="card-block">
					...
					<div class="table-responsive m-t-40">
						<table class="table stylish-table">
							...
							<tbody>
								...
								<tr>
                                    ...
                                    <?php /* ?><td><a href="<?php echo base_url()."project/project_details/".$list->project_id; ?>">View</a></td><?php */ ?>
								<?php /* ?></tr>
                                <?php $i = $i + 1; 
										} 
									}
						...
						<?php /* ?><a href="<?php echo base_url()."project/project_list"; ?>" class="btn pull-right hidden-sm-down btn-success" style="margin-right:55px;"> View All</a><?php */ ?>
					<?php /* ?></div>
			...
			<div class="card">
				<div class="card-block">
					...
					<div class="table-responsive m-t-40">
						<table class="table stylish-table">
							...
							<tbody>
								...
								<tr>
                                    ...
                                    <?php /* ?><td><a href="<?php echo base_url()."task/view_task/".$list->task_id; ?>">View</a></td><?php */ ?>
								<?php /* ?></tr>
                                <?php $i = $i + 1; 
										} 
									}
						...
						<?php /* ?><a href="<?php echo base_url()."task/task_list"; ?>" class="btn pull-right hidden-sm-down btn-success" style="margin-right:55px;"> View All</a><?php */ ?>
					<?php /* ?></div>
