                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <div class="card-block">
								<?php echo form_open('task/update_task',array('class' => '','id'=>'update_task')); ?>
                                <input type="hidden" name="user_id" value="<?php echo $task_details[0]->user_id; ?>" />
                                    ...
                                    <div class="form-group" style="margin-bottom: 5px;">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="start_time" placeholder="" class="form-control form-control-line" value="<?php echo $task_details[0]->task_start_time; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 5px;">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="end_time" placeholder="" class="form-control form-control-line" value="<?php echo $task_details[0]->task_end_time; ?>">
                                        </div>
                                    </div>
