                            ...
                            <div class="card-block">
                               ...
                               <?php echo form_open_multipart(); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                             <input type="text" name="department-id" placeholder="" class="form-control form-control-line" value="<?php if($emp_details[0]->department_id==1){ echo 'Design & Development';}else if($emp_details[0]->department_id==2){ echo 'SEO';}else if($emp_details[0]->department_id==3){ echo 'Contents';}else{ echo 'Accounts';} ?>" disabled>
                                        </div>
                                    </div>
	...
	<div class="modal-dialog">
	  ...
	  <div class="modal-content">
		...
		<!--<form class="feedback" name="feedback" action="javascript:void(0);" method="POST">-->
			...
			<div class="col-md-8 col-8 align-self-center" name="notice_name" id="notice_name">
			...
			<div class="col-md-8 col-8 align-self-center" name="notice_msg" id="notice_msg">
			...
			<div class="col-md-8 col-8 align-self-center" name="notice_date" id="notice_date">
			...
			<div class="col-md-8 col- 8 align-self-center" name="notice_file" id="notice_file">
			...
			<div class="col-md-8 col-8 align-self-center" name="notice_type" id="notice_type">
