...
<div class="container-fluid">
	...
	<div class="row page-titles">
		...
		<button type="button" name="add_document" data-toggle="collapse" data-target="#add_document" onclick="toggler(this)" class="btn btn-success pull-right fa fa-file">Add Documents</button>
		</div>
...
?>
	...
	<div id="add_document" class="collapse">
	<div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <div class="card-block">
								<?php echo form_open_multipart('document/do_add_document',array('class' => '','id'=>'add_docs','onsubmit'=>'return add_document_func()')); ?>
                               
									<div class="form-group" style="margin-bottom: 5px;">
                                        <label class="col-md-12">Document Type</label>
                                        <div class="col-md-12">
                                            <select class="form-control form-control-line" name="document_type" id="document_type">
												<option value="">Select...</option>
												<option value="1">Pay Slip</option>
                                    ...
                                    <div class="form-group" style="margin-bottom: 5px;">
                                        ...
                                        <div class="col-md-12">
                                            <select class="form-control form-control-line" name="employee_id" id="employee_id" onchange="">
												<option value="">Select...</option>
									...
									<div class="form-group" style="margin-bottom: 5px;">
                                        <label class="col-md-12">Month</label>
											<div class="col-md-12">
												<select class="form-control form-control-line" name="document_month" id="document_month">
													<option value="">Select...</option>		
                                    ...
                                    <div class="form-group" style="margin-bottom: 5px;">
                                        <label for="document_date" class="col-md-12"> Date</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="" class="form-control form-control-line" name="document_date" id="document_date" value="<?php $today = getdate(); echo $today['mon'].'/'.$today['mday'].'/'.$today['year']; ?>" readonly>
                                        </div>
                                    </div>
                                    
									
									<div class="form-group" style="margin-bottom: 5px;">
                                        <label for="userfile" class="col-md-12">Attachment</label>
                                        <div class="col-md-12">
											<input type="file" class="form-control" name="userfile" id="userfile" style="">
                                        </div>
                                    </div>
							 ...
							 ?>
								<tr <?php if($slip->notification_status ==0){ echo "style='background:#E1E1D2 !important;'"; } ?>>
									<td width="350px"><h5><?php echo $slip->document_month; ?></h5><small><?php //if($slip->employee_designation == 1){echo 'Project Manager';}
																								...
																								?></small></td>
									<td><?php echo $slip->name; ?></td>
									<td><?php $s_date = view_date_format($slip->document_added_date);
													echo $s_date; ?></td>
									<!--<td>
										<?php 
											//if( $slip->leave_status==0){echo 'Pending';}
											//if( $slip->leave_status==1){echo 'Approved';}
											//if( $slip->leave_status==2){echo 'Declined';}
										?>
									</td>-->
									<td>
										<button name="casual_view" id="casual_view" data-nott-id="<?php echo $slip->document_id ?>" data-id="<?php echo $slip->name ?>" data-name-id="<?php echo $slip->document_type ?>" data-msg-id="<?php echo $slip->document_src ?>" data-sdate-id="<?php echo $s_date ?>" data-days-id="<?php echo $slip->document_month ?>" data-file-id="<?php echo $slip->document_src ?>" data-type-id="Pay-Slip" data-nots-id="<?php echo $slip->document_type ?>" class="g_view btn btn-success" data-toggle="modal" data-target="#viewModal">View</button>
										<a href="<?php echo base_url()."document/delete_document/".$slip->document_id; ?>"><button name="delete_casual" id="delete_casual" class="btn hidden-sm-down btn-danger">Delete</button></a>
  ...
  <div class="table-responsive m-t-40">
						<table class="table stylish-table">
							...
							?></small></td>
									...
									<td>
										<button name="paid_view" id="paid_view" data-nott-id="<?php echo $offer->document_id ?>" data-id="<?php echo $offer->name ?>" data-name-id="<?php echo $offer->document_type ?>" data-msg-id="<?php echo $offer->document_src ?>" data-sdate-id="<?php echo $s_date ?>" data-days-id="<?php echo $offer->document_month ?>" data-file-id="<?php echo $offer->document_src ?>" data-type-id="Offer Letter" data-nots-id="<?php echo $offer->document_type ?>" class="g_view btn btn-success" data-toggle="modal" data-target="#viewModal">View</button>
										<a href="<?php echo base_url()."document/delete_document/".$offer->document_id; ?>"><button name="delete_paid" id="delete_paid" class="btn hidden-sm-down btn-danger">Delete</button></a>
							...
							<?php //$task_list = get_main_task_list_by_id($list->project_id); 
							 ...
							 ?>
								<tr <?php if($appointment->notification_status ==0){ echo "style='background:#E1E1D2 !important;'"; } ?>>
									...
									<td>
										<button name="sick_view" id="sick_view" data-nott-id="<?php echo $appointment->document_id ?>" data-id="<?php echo $appointment->name ?>" data-name-id="<?php echo $appointment->document_type ?>" data-msg-id="<?php echo $appointment->document_src ?>" data-sdate-id="<?php echo $s_date ?>" data-days-id="<?php echo $appointment->document_month ?>" data-file-id="<?php echo $appointment->document_src ?>" data-type-id="Appointment Letter" data-nots-id="<?php echo $appointment->document_type ?>" class="g_view btn btn-success" data-toggle="modal" data-target="#viewModal">View</button>
										<a href="<?php echo base_url()."document/delete_document/".$appointment->document_id; ?>"><button name="delete_sick" id="delete_sick" class="btn hidden-sm-down btn-danger">Delete</button></a>
            ...
            <div class="col-md-12">
                <div class="tab" role="tabpanel">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#Section1" aria-controls="home" role="tab" data-toggle="tab"><i class="fa fa-money"></i><span>Pay Slips</span></a></li>
                        <li role="presentation"><a href="#Section2" aria-controls="profile" role="tab" data-toggle="tab"><i class="fa fa-globe"></i><span>Offer Letter</span></a></li>
                        <li role="presentation"><a href="#Section3" aria-controls="messages" role="tab" data-toggle="tab"><i class="fa fa-briefcase"></i><span>Appointment Letter</span></a></li>
                    </ul>
                    <!-- Tab panes -->
                    <div class="tab-content tabs">
							...
							<?php //$task_list = get_main_task_list_by_id($list->project_id); 
							 ...
							 ?>
								<tr>
									...
									<td>
										<button name="casual_view" id="casual_view" data-id="<?php echo $slip->name ?>" data-name-id="<?php echo $slip->document_type ?>" data-msg-id="<?php echo $slip->document_src ?>" data-sdate-id="<?php echo $s_date ?>" data-days-id="<?php echo $slip->document_month ?>" data-file-id="<?php echo $slip->document_src ?>" data-type-id="Pay-Slip" class="g_view btn btn-success" data-toggle="modal" data-target="#viewModal">View</button>
										<a href="<?php echo base_url()."document/delete_document/".$slip->document_id; ?>"><button name="delete_casual" id="delete_casual" class="btn hidden-sm-down btn-danger">Delete</button></a>
						...
						<table class="table stylish-table">
							...
							?></small></td>
									...
									<td>
										<button name="paid_view" id="paid_view" data-id="<?php echo $offer->name ?>" data-name-id="<?php echo $offer->document_type ?>" data-msg-id="<?php echo $offer->document_src ?>" data-sdate-id="<?php echo $s_date ?>" data-days-id="<?php echo $offer->document_month ?>" data-file-id="<?php echo $offer->document_src ?>" data-type-id="Offer Letter" class="g_view btn btn-success" data-toggle="modal" data-target="#viewModal">View</button>
										<a href="<?php echo base_url()."document/delete_document/".$offer->leave_id; ?>"><button name="delete_paid" id="delete_paid" class="btn hidden-sm-down btn-danger">Delete</button></a>
							...
							<?php //$task_list = get_main_task_list_by_id($list->project_id); 
							 ...
							 ?>
								<tr>
									...
									<td>
										<button name="sick_view" id="sick_view" data-id="<?php echo $appointment->name ?>" data-name-id="<?php echo $appointment->leave_type ?>" data-msg-id="<?php echo $appointment->document_src ?>" data-sdate-id="<?php echo $s_date ?>" data-days-id="<?php echo $appointment->document_month ?>" data-file-id="<?php echo $appointment->document_src ?>" data-type-id="Appointment Letter" class="g_view btn btn-success" data-toggle="modal" data-target="#viewModal">View</button>
										<a href="<?php echo base_url()."document/delete_document/".$appointment->document_id; ?>"><button name="delete_sick" id="delete_sick" class="btn hidden-sm-down btn-danger">Delete</button></a>
...
/* Document View Script*/
	...
	$(document).on("click", ".g_view", function () {
		...
		if(file){
			 var file ='<a href="<?php echo base_url() ?>assets/upload/notices/'+file+'" target="_blank">'+file+'</a>';
		}
		else{
			 file = "No Attachment!";
		}
