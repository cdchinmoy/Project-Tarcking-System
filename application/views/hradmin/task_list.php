                    ...
                    <div class="col-sm-12">
                     <div class="card">
                        ...
                        <?php echo form_open('task/filter_task_list',array('class' => '','id'=>'task_list')); ?>
                            ...
                            <div class="" style="float:left;">
                                <div class="col-md-4 col-4 align-self-center">
                                    <input type="submit" class="form-control btn-success" style="width: 220px;" name="search" value="Filter" >
                                </div>
                            </div>
                                    ...
                                    <table class="table table-hover table-bordered results">
                                        ...
                                        <tbody>
                                          <?php 
                                            ...
                                            <tr id="trid_<?php echo $list->task_id; ?>" <?php //if($list->notification_status ==0){ echo "style='background:#0F9 !important;'"; } ?>>
