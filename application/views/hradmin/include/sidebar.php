...
<div class="scroll-sidebar">
	...
	<nav class="sidebar-nav">
		<ul id="sidebarnav">
			...
			<?php /* ?><li>				
				<a href="<?php echo base_url()."project/project_list"; ?>" class="waves-effect"><i class="fa fa-table m-r-10" aria-hidden="true"></i>Project</a></li>
            <li>				
				<a href="<?php echo base_url()."task/project_milestone"; ?>" class="waves-effect"><i class="fa fa-table m-r-10" aria-hidden="true"></i>Project Milestone</a></li>						
			<li>
...
function get_dash_notification()
{
	$.ajax({
		...
		success: function(data){
			...
			if(data[1] != 0){
				$('#general_notify').html(data[1]);
			}
			if(data[2] != 0){
				$('#warning_notify').html(data[2]);
			}
			if(data[3] != 0){
				$('#review_notify').html(data[3]);
			}
			if(data[4] != 0){
				$('#pay_notify').html(data[4]);
			}
		}
	});
}
