                            ...
                            <div class="card-block">
                                <?php echo form_open_multipart('dashboard/do_update'); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                             <input type="text" name="department-id" placeholder="" class="form-control form-control-line" value="<?php if($user_details[0]->department_id==1){ echo 'Design & Development';}else if($user_details[0]->department_id==2){ echo 'SEO';}else if($user_details[0]->department_id==3){ echo 'Contents';}else if($user_details[0]->department_id==4){ echo 'Accounts';}else{ echo 'Human Resource';} ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">                                        
									<label for="userfile" class="col-md-12">Picture</label>                                        
									<div class="col-md-12">                                             
									<input type="file" name="userfile" placeholder="" class="form-control form-control-line">                                        </div>                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
