...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="<?php echo base_url()."login/check_login"; ?>" method="post" class="login-form">
							...
							<p><a href="<?php echo base_url()."login/password_recovery"; ?>">Forgot Password?</p>
                        </div>
                    </div>
        ...
        <![endif]-->
		<script>
			setTimeout(function () {document.getElementById('rec_pass').style.display='none'}, 3000);
		</script>
    </body>
